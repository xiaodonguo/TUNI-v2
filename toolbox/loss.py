...
class SoftmaxCrossEntropyOHEMLoss(nn.Module):
    def __init__(self, ignore_label=-1, thresh=0.7, min_kept=256, use_weight=True, **kwargs):
        ...
        if use_weight:
            ...
            '''
            weight = torch.FloatTensor([0.8373, 0.918, 0.866, kd_loss.0345, kd_loss.0166, 0.9969, 0.9754,
                                        kd_loss.0489, 0.8786, kd_loss.0023, 0.9539, 0.9843, kd_loss.1116, 0.9037, kd_loss.0865, kd_loss.0955,
                                        kd_loss.0865, kd_loss.1529, kd_loss.0507])'''
