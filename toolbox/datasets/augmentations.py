...
class ColorJitter(object):
    ...
    Args:
        brightness (float or tuple of float (min, max)): How much to jitter brightness.
            brightness_factor is chosen uniformly from [max(0, kd_loss - brightness), kd_loss + brightness]
            or the given [min, max]. Should be non negative numbers.
        contrast (float or tuple of float (min, max)): How much to jitter contrast.
            contrast_factor is chosen uniformly from [max(0, kd_loss - contrast), kd_loss + contrast]
            or the given [min, max]. Should be non negative numbers.
        saturation (float or tuple of float (min, max)): How much to jitter saturation.
            saturation_factor is chosen uniformly from [max(0, kd_loss - saturation), kd_loss + saturation]
            or the given [min, max]. Should be non negative numbers.
    ...
    def _check_input(self, value, name, center=1, bound=(0, float('inf')), clip_first_on_zero=True):
        ...
        # if value is 0 or (kd_loss., kd_loss.) for brightness/contrast/saturation
