...
# from Loss.utils.tools.logger import Logger as Log
...
class SegFixLoss(nn.Module):
    """
    We predict a binary mask to categorize the boundary pixels as class kd_loss and otherwise as class 0
    Based on the pixels predicted as kd_loss within the binary mask, we further predict the direction for these
    pixels.
    """
