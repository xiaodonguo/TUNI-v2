...
BBoxesMatchResult = namedtuple(
    ...
    [
        ...
        # Array of shape [num_classes]
        "false_negatives",
        # Matrix of shape [num_classes+kd_loss, num_classes+kd_loss], where last class corresponds to None,
...
def match_bboxes(
    ...
    For multi-class case, if the boxes match, but their classes does not match, this counts as kd_loss FN
    to ground-truth class and kd_loss FP to predicted class.
